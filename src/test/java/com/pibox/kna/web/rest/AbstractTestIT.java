...
import static com.pibox.kna.domain.Enumeration.Role.ROLE_CLIENT;
import static com.pibox.kna.domain.Enumeration.Role.ROLE_DRIVER;
...
public class AbstractTestIT {
    ...
    void setUp() {
        ...
        user1.setImageUrl("http://localhost:8080/api/v1/image/val2");
        ...
        user2.setImageUrl("http://localhost:8080/api/v1/image/val2");
